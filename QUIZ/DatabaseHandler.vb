...
Module DatabaseHandler
    ...
    'Public sqlViewCon As MySqlConnection = New MySqlConnection("server=sprite;user id=root; password=bamysqlroot; database=quiz; check parameters=false; Connect Timeout=120")
